...
20    | R 3/5    | Conducting a reproducible analyses with `git`/github | [Cheatsheet](http://htmlpreview.github.io/?https://github.com/sjspielman/datascience_for_biologists/blob/master/materials/github_cheatsheet.html)  | `Working with untidy and tidy data` assignment due on Blackboard **NEXT TUESDAY AT 11 AM**
