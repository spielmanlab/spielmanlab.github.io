...
7  | W 2/5   | Scientific Method: Representing and Summarizing Data II | [Data Visualization Worksheet](worksheets/dataviz.pdf) [**Solutions**](worksheets/solutions/dataviz_SOLUTIONS.pdf) | None | None
...
17 | F 2/28  | Modes of natural selection and [sexual selection](slides/slides_sexualselection.pdf) | None |  1. Read Chapter 3.5, and Chapter 4 sections 4.1, 4.2, 4.3, 4.4, 4.5, and 4.7 (not 4.6) <br> 2. EvoDots Assignment due on Blackboard  | **Concepts in Selection Assignment due next Friday is WITHIN BLACKBOARD**
