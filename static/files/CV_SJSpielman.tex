...
\item \textbf{SJ Spielman} and M Miraglia$^\ast$. 2021. ``Relative model selection can be sensitive to multiple sequence alignment uncertainty.'' In press at \emph{BMC Ecology and Evolution}.
...
\vspace*{0.35cm}
\begin{rSection}{Preprints and Preprinted Submitted Manuscripts}
\vspace*{0.25cm}
...
\\ Contributed Poster at Annual Meeting for Society of Molecular Biology and Evolution, 2021. 
\\ Virtual conference.
...
\\ Accepted Poster at Annual Meeting for Society of Molecular Biology and Evolution, 2020). \emph{Conference canceled due to COVID-19}. \\
...
\\Invited poster at ``Modeling the Spread and Control of Ebola in West Africa: A Rapid Response Workshop'', 2014.
\\ Georgia Institute of Technology, Atlanta, GA.\\

\textbf{Limited utility of residue masking for positive-selection inference.}
\\Contributed poster at ``2nd Annual Symposium on Big Data in Biology'', 2014.
\\ UT Austin, Austin, TX.\\

\textbf{The molecular evolution of membrane proteins.}
\\Contributed talk at Society of Molecular Biology and Evolution Satellite Meeting: ``Mechanisms of Protein Evolution II'', 2013.
