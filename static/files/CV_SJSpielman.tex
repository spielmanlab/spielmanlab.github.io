...
\item N Srivastava$^\ast$, \textbf{SJ Spielman}, S Morrison, and EK Moore. 2021. ``Geological factors that impacted cadmium availability to be used as an alternative cofactor for zinc in the carbon fixation pathways of marine diatoms.''  \emph{Journal of Geophysical Research: Biogeosciences }. In Press.
...
\\Contributed talk at \emph{SMBE Satellite Meeting MPEII}, 2013.
\\ University of Colorado, Aurora, CO. \\

\textbf{Membrane environment imposes unique selection pressures on GPCRs.}
\\Contributed poster at \emph{Annual BEACON Congress}, 2013.
...
\\ \textbf{C Bethell} and SJ Spielman.
\\ Contributed Poster at \emph{RUSSS 2019}.
\\ Rowan University, Glassboro, NJ.\\


\textbf{Bolded names} indicate undergraduate student presenters.
