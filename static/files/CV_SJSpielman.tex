...
\item SL Kosakovsky Pond, AFY Poon, R Velazquez, S Weaver, N Lance Hepler, B Murrell, SD Shank, B Rife Magalis, D Bouvier, A Nekrutenko, S Wisotsky, \textbf{SJ Spielman}, SDW Frost, SV Muse. 2019. ``HyPhy 2.5 – a customizable platform for evolutionary hypothesis testing using phylogenies.'' \emph{Molecular Biology and Evolution}. In Press.

%\item EK Moore, J Hao, \textbf{SJ} Spielman, and N Yee. In Press. ``The Evolving Redox Chemistry and Bioavailability of Vanadium in Deep Time.'' \emph{Geobiology}.
...
\item N Srivastava, \textbf{SJ Spielman}, and EK Moore. Under Review. ``Geological factors that impacted cadmium availability to be used as an alternative cofactor for zinc in the carbon fixation pathways of marine diatoms.''

\item \textbf{SJ Spielman} and EK Moore. Under Review. ``dragon: A New Tool for Exploring Redox Evolution Preserved in the Mineral Record.''

\item EK Moore, J Hao, \textbf{SJ Spielman}, and N Yee. Under Review. ``The Evolving Redox Chemistry and Bioavailability of Vanadium in Deep Time.''

\item \textbf{SJ Spielman}. 2019. ``Model fit does not predict accuracy in single-gene protein phylogenetics.'' \emph{bioRxiv}. \url{https://doi.org/10.1101/698860}.
...
\textbf{Instructor, Introduction to Evolution and Scientific Inquiry} \hfill Fall 2018 -- Present  \\ Rowan University \\
...
\textbf{Peer Reviewer} \\ \emph{Molecular Biology and Evolution}, \emph{Systematic Biology}, \emph{Genome Biology and Evolution}, \emph{Molecular Phylogenetics and Evolution}, \emph{PLoS Computational Biology}, \emph{Bioinformatics}, \emph{BMC Evolutionary Biology},  \emph{BMC Bioinformatics}, \emph{PeerJ}, \emph{Philosophical Transactions of the Royal Society B}, \emph{Genes}, \emph{Journal of Molecular Evolution}
